...
<div class="container_video w-[70%] m-auto">
    <div class="video_card w-[100%] h-auto ">
        <div class="card  w-full h-full shadow-sm bg-white showVideoBtn">
            ...
            <div class="description w-full h-[40%] relative pt-10 pb-5 pr-4 pl-4">
                <p
                    class="text1 absolute top-2 line-clamp-2 text-blue-800 text-xl font-Kantumruy font-normal leading-normal">
                    ម្ដេចក្រឡាហោម ស ខេង អញ្ជើញជាអធីបតីក្នុងទិវាអន្ដរជាតិប្រយុទ្ធប្រឆាំងគ្រឿងញៀន</p>
                <p class="absolute top-[60%] text-blue-800 font-Kantumruy font-normal">ថ្ងៃអាទិត្យ ទី២ ខែកក្កដា
                    ឆ្នាំ២០២៣</p>
            </div>
        </div>
        <div class="card  w-full h-full shadow-sm bg-white showVideoBtn">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // popup video modal
        var buttons = document.querySelectorAll(".showVideoBtn");
        var closePopupBtn = document.getElementById("closePopupBtn");

        buttons.forEach(function(button) {
            button.addEventListener("click", function() {
                // Get the video popup element
                var videoPopup = document.querySelector(".video_popup");

                // Toggle the 'hidden' class to show/hide the popup
                videoPopup.classList.toggle("hidden");
            });
        });
