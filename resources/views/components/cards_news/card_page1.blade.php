...
<section class="full_card w-[100%] h-auto">
    <div class="full_card-container">
        <div class="card">
            ...
            <div class="box_title">
                ...
                <p class="txt3">នាព្រឹកថ្ងៃព្រហស្បតិ៍ ១កើត ខែស្រាពណ៍ ឆ្នាំថោះ បញ្ចស័ក ព.ស២៥៦៧ ត្រូវនឹងថ្ងៃទី១៧
                    ...
                    នៃក្រសួងមហាផ្ទៃ។</p>
                <div class="btn_share">
                    <button type="button" class="btn showShareDailogBtn">
        ...
        <div class="card">
            <div class="box_img">
                <a href="{{ route('ReadNews') }}"> <img src="./assets/image/image_news/card_img2.jpeg"
                        alt=""></a>
            </div>
            <div class="box_title">
                <a href="{{ route('ReadNews') }}">
        ...
        <div class="card">
            <div class="box_img">
                <a href="{{ route('ReadNews') }}"> <img src="./assets/image/image_news/card_img3" alt=""></a>
            </div>
            <div class="box_title">
                <a href="{{ route('ReadNews') }}">
                    <p class="txt1">សម្ដេចក្រឡាហោម ស ខេង និងលោកជំទាវ អញ្ជើញជាអធិបតីក្នុងពិធីក្រុងពាលី
        ...
        <div class="card">
            <div class="box_img">
                <a href="{{ route('ReadNews') }}"> <img src="./assets/image/image_news/card_img4.jpg"
                        alt=""></a>
            </div>
            <div class="box_title">
                <a href="{{ route('ReadNews') }}">
        ...
        <div class="card">
            <div class="box_img">
                <a href="{{ route('ReadNews') }}"> <img src="./assets/image/image_news/card_img5.jpg"
                        alt=""></a>
            </div>
            <div class="box_title">
                <a href="{{ route('ReadNews') }}">
        ...
        <div class="card">
            <div class="box_img">
                <a href="{{ route('ReadNews') }}"> <img src="./assets/image/image_news/card_img6.jpg"
                        alt=""></a>
            </div>
            <div class="box_title">
                <a href="{{ route('ReadNews') }}">
