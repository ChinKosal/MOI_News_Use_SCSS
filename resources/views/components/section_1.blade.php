<section class="w-[100%] FULL">
    <div class="FULL-container_section flex gap-5 ">
        <div class="swiper1 w-[68%] h-full relative z-[99] overflow-hidden">
            ...
            <div class="absolute bottom-0 z-[100] icon_change flex justify-center items-center gap-2">
                ...
                <button id="change2" class="border-none bg-transparent hover:cursor-pointer">
                    <div class="icon_change-icon">
                    </div>
                </button>
                <button id="change3" class="border-none bg-transparent hover:cursor-pointer">
                    <div class="icon_change-icon">
                    </div>
                </button>
                <button id="change4" class="border-none bg-transparent hover:cursor-pointer">
                    <div class="icon_change-icon">
                    </div>
                </button>
                <button id="change5" class="border-none bg-transparent hover:cursor-pointer">
                    <div class="icon_change-icon">
                    </div>
                </button>
            </div>
