<div
    class="hidden video_popup fixed top-0 bottom-0 z-[999999999] w-[100%] h-[100%]  bg-opacity-50 bg-black backdrop-blur-5">
    <div class="modal_box w-full h-full relative">
        <div class="toggle_exit absolute top-5 right-4" id="closePopupBtn">
